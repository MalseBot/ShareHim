...
function CreatePin({ user }) {
  ...
  const savePin = () => {
    if (title && about && destination && imageAsset && imageAsset?._id && category) {
      const doc = {
        _type: 'pin',
        title,
        about,
  ...
  return (
    <div className='flex flex-col items-center justify-center mt-5 lg:h-4/5'>
      ...
      <div className='flex lg:flex-row flex-col bg-white lg:p-5 justify-center items-center p-3 lg:w-4/5 w-full'>
              ...
              <label>
                <div className='flex flex-col justify-center items-center h-full'>
                  ...
                  <p className=' mt-32 text-gray-400'>
                    Reccomandation: use high-cuality JPG,SVG,PNG,GIF or TIFF
                    less than 20 MB
                  </p>
                </div>
                <input
